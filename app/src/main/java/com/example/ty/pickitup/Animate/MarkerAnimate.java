package com.example.ty.pickitup.Animate;
...
public class MarkerAnimate {
    public static void animateMarkerToGB(final Marker marker, final LatLng finalPosition, final LatLngInterpolator latLngInterpolator, int duration) {
